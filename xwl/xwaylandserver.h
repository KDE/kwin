...
class XwaylandServer : public XwaylandInterface
{
    Q_OBJECT

public:
    static XwaylandServer *self();

    explicit XwaylandServer(ApplicationWaylandAbstract *app, QObject *parent = nullptr);
    ~XwaylandServer() override;
