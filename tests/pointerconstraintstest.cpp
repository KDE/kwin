...
void WaylandBackend::lockRequest(bool persistent, QRect region)
{
    ...
    auto *lockedPointer = m_pointerConstraints->lockPointer(winSurface.data(), m_pointer, wlRegion.data(), lifeTime(persistent), this);
...
void WaylandBackend::confineRequest(bool persistent, QRect region)
{
    ...
    auto *confinedPointer = m_pointerConstraints->confinePointer(winSurface.data(), m_pointer, wlRegion.data(), lifeTime(persistent), this);
