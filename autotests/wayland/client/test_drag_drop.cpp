...
void TestDragAndDrop::testPointerEventsIgnored()
{
    ...
    m_seatInterface->setTimestamp(timestamp++);
    m_seatInterface->notifyPointerAxis(Qt::Vertical, 5, 120, InputDevice::PointerAxisSource::Wheel);
    m_seatInterface->notifyPointerFrame();
    ...
    m_seatInterface->notifyPointerFrame();
    m_seatInterface->setTimestamp(timestamp++);
    m_seatInterface->notifyPointerAxis(Qt::Vertical, 5, 1, InputDevice::PointerAxisSource::Wheel);
    m_seatInterface->notifyPointerFrame();
    m_seatInterface->setTimestamp(timestamp++);
    m_seatInterface->notifyPointerAxis(Qt::Vertical, 5, 1, InputDevice::PointerAxisSource::Wheel);
    m_seatInterface->notifyPointerFrame();
