...
void OpenGLContextAttributeBuilderTest::testEgl_data()
{
    ...
    QTest::newRow("core") << true << 3 << 1 << false << false << false << false << false
                          << std::vector<int>{EGL_CONTEXT_MAJOR_VERSION_KHR, 3, EGL_CONTEXT_MINOR_VERSION_KHR, 1, EGL_NONE};
    ...
    QTest::newRow("core/robust/forward compatible/high priority")
        ...
        << std::vector<int>{EGL_CONTEXT_MAJOR_VERSION_KHR,
                            ...
                            EGL_LOSE_CONTEXT_ON_RESET_KHR,
                            EGL_CONTEXT_FLAGS_KHR,
                            EGL_CONTEXT_OPENGL_ROBUST_ACCESS_BIT_KHR | EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT_KHR,
                            EGL_CONTEXT_PRIORITY_LEVEL_IMG,
                            EGL_CONTEXT_PRIORITY_HIGH_IMG,
                            EGL_NONE};
...
void OpenGLContextAttributeBuilderTest::testGles_data()
{
    ...
    QTest::newRow("robust") << true << false
                            << std::vector<int>{EGL_CONTEXT_CLIENT_VERSION,
                                                ...
                                                EGL_NONE};
    QTest::newRow("robust/high priority") << true << true
                                          << std::vector<int>{EGL_CONTEXT_CLIENT_VERSION,
                                                              2,
                                                              EGL_CONTEXT_OPENGL_ROBUST_ACCESS_EXT,
                                                              EGL_TRUE,
                                                              ...
                                                              EGL_CONTEXT_PRIORITY_HIGH_IMG,
                                                              EGL_NONE};
    QTest::newRow("normal") << false << false << std::vector<int>{EGL_CONTEXT_CLIENT_VERSION, 2, EGL_NONE};
    QTest::newRow("normal/high priority")
        << false << true << std::vector<int>{EGL_CONTEXT_CLIENT_VERSION, 2, EGL_CONTEXT_PRIORITY_LEVEL_IMG, EGL_CONTEXT_PRIORITY_HIGH_IMG, EGL_NONE};
}
...
void OpenGLContextAttributeBuilderTest::testGlx_data()
{
    ...
    QTest::newRow("fallback") << true << 2 << 1 << false << false << std::vector<int>{GLX_CONTEXT_MAJOR_VERSION_ARB, 2, GLX_CONTEXT_MINOR_VERSION_ARB, 1, 0};
    QTest::newRow("legacy/robust") << false << 0 << 0 << true << false
                                   << std::vector<int>{GLX_CONTEXT_FLAGS_ARB,
                                                       ...
                                                       0};
    QTest::newRow("legacy/robust/videoPurge") << false << 0 << 0 << true << true
                                              << std::vector<int>{GLX_CONTEXT_FLAGS_ARB,
                                                                  GLX_CONTEXT_ROBUST_ACCESS_BIT_ARB,
                                                                  GLX_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB,
                                                                  GLX_LOSE_CONTEXT_ON_RESET_ARB,
                                                                  ...
                                                                  GL_TRUE,
                                                                  0};
    QTest::newRow("core") << true << 3 << 1 << false << false << std::vector<int>{GLX_CONTEXT_MAJOR_VERSION_ARB, 3, GLX_CONTEXT_MINOR_VERSION_ARB, 1, 0};
    QTest::newRow("core/robust") << true << 3 << 1 << true << false
                                 << std::vector<int>{GLX_CONTEXT_MAJOR_VERSION_ARB,
                                                     ...
                                                     GLX_LOSE_CONTEXT_ON_RESET_ARB,
                                                     0};
    QTest::newRow("core/robust/videoPurge") << true << 3 << 1 << true << true
                                            << std::vector<int>{GLX_CONTEXT_MAJOR_VERSION_ARB,
                                                                3,
                                                                GLX_CONTEXT_MINOR_VERSION_ARB,
                                                                1,
