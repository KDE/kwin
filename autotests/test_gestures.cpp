...
void GestureTest::testSwipeUpdateTrigger_data()
{
    ...
    QTest::newRow("Up") << GestureDirection::Up << QSizeF(2, -400);
    QTest::newRow("Left") << GestureDirection::Left << QSizeF(-400, 1);
    QTest::newRow("Right") << GestureDirection::Right << QSizeF(400, -19);
    QTest::newRow("Down") << GestureDirection::Down << QSizeF(0, 500);
}
