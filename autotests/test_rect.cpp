...
void TestRect::scaleByMultiplying()
{
    QCOMPARE(Rect() * 2.5, RectF());
    QCOMPARE(Rect(1, 2, 3, 4) * 2.5, RectF(2.5, 5.0, 7.5, 10.0));
}

void TestRect::scaleByDividing()
{
    QCOMPARE(Rect() / 2.5, RectF());
    QCOMPARE(Rect(1, 2, 3, 4) / 2.5, RectF(0.4, 0.8, 1.2, 1.6));
}
