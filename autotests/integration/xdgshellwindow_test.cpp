...
void TestXdgShellWindow::testXdgPopupReactive_data()
{
    ...
    QTest::addRow("reactive") << true << QPointF(0, 1024) << QPointF(50, 1024 + 40);
    QTest::addRow("not reactive") << false << QPointF(0, 1024) << QPointF(50, 1024 - 10);
}
...
void TestXdgShellWindow::testXdgPopupReactive()
{
    ...
    // TODO Plasma 6: Remove keepInArea() in Placement::placeTransient().
    QEXPECT_FAIL("reactive", "kwin always keeps popups in work area", Continue);
