...
void TransientPlacementTest::testXdgPopup_data()
{
    ...
    QTest::newRow("constraintFlipBottomRight") << QSize(500, 500) << QPoint(700, 500) << layoutFlipBottomRight
...
void TransientPlacementTest::testXdgPopup()
{
    ...
    auto popup = Test::createXdgPopupSurface(transientSurface,
                                             parentShellSurface->xdgSurface(),
                                             positioner.data(),
                                             Test::waylandCompositor(),
