...
private Q_SLOTS:
    ...
    void testEvacuateFromRemovedOutput_data();
    void testEvacuateFromRemovedOutput();
};
...
void OutputChangesTest::testEvacuateFromRemovedOutput_data()
{
...
void OutputChangesTest::testEvacuateFromRemovedOutput()
{
    Test::setOutputConfig({
        Test::OutputInfo{
            .geometry = QRect(0, 0, 5120, 1440),
