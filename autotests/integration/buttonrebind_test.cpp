...
void TestButtonRebind::testBindingTabletTool()
{
    ...
    const QRectF startGeometry = window->frameGeometry();
    Test::tabletToolProximityEvent(startGeometry.center(), 0, 0, 0, 0, false, false, timestamp++);
...
void TestButtonRebind::testMouseTabletCursorSync()
{
    ...
    Test::tabletToolProximityEvent(startGeometry.topLeft() + QPointF{10.f, 10.f}, 0, 0, 0, 0, false, false, timestamp++);
