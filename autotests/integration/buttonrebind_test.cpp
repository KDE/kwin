...
void TestButtonRebind::testBindingTabletTool()
{
    ...
    const QRectF startGeometry = window->frameGeometry();
    Test::tabletToolProximityEvent(startGeometry.center(), 1.0, 0, 0, 0, 0, false, false, 0, timestamp++);
...
void TestButtonRebind::testMouseTabletCursorSync()
{
    ...
    Test::tabletToolProximityEvent(startGeometry.topLeft() + QPointF{10.f, 10.f}, 1.0, 0, 0, 0, 0, false, false, 0, timestamp++);
