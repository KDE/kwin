...
private:
    QScopedPointer<EffectContext> context1;
    QScopedPointer<EffectContext> context2;
    QScopedPointer<EffectContext> context3;
    bool active1 = false;
    bool active2 = false;
    bool active3 = false;
...
void ContextsTest::forceCompleteTransitions()
{
    ...
    context2->grabActive(true); // true means force complete
