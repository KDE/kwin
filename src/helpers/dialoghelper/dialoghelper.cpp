...
int main(int argc, char *argv[])
{
    ...
    KMessageBox::ButtonCode dontAgainCode;
    if (!KMessageBox::shouldBeShownTwoActions(dontAgainKey, dontAgainCode)) {
        fprintf(stdout, "%s\n", qPrintable(i18n("User wants us to not ask again")));
        return 0;
    }
    ...
    QObject::connect(dialog, &QDialog::finished, &app, [dialog, dontAgainKey](int result) {
