...
public:
    ...
    virtual void strokeGestureBegin(const std::vector<QPointF> &points, std::chrono::microseconds time);
    virtual void strokeGestureUpdate(const std::vector<QPointF> &points, std::chrono::microseconds time);
