...
public:
    ...
    /*!
     * Constructs a region from the given list of sorted rectangles \a rects. The rectangles must
     * not overlap and they have to be sorted by the top edge coordinate. Rectangles with the same
     * top edge coordinate must be sorted by the left edge coordinate and share the same bottom edge
     * coordinate.
     *
     ...
     * stored in any order in the list. However, there should be no empty rectangles in the list.
     *
     ...
     * must be sorted by the top edge position. The rectangles are allowed to overlap. The rectangles
     * with the same top edge coordinate are not required to be sorted by the left edge coordinate and
     * share the same bottom edge coordinate. There should be no empty rectangles in the list.
     *
