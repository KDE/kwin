...
const ColorDescription &BackendOutput::colorDescription() const
{
...
bool BackendOutput::updateCursorLayer(std::optional<std::chrono::nanoseconds> allowedVrrDelay)
{
    return false;
}
...
const ColorDescription &BackendOutput::blendingColor() const
{
    return m_state.blendingColor;
}

const ColorDescription &BackendOutput::layerBlendingColor() const
{
