...
private:
    ...
    std::unique_ptr<KWaylandServer::ContentTypeManagerV1Interface> m_contentTypeManager;
    std::unique_ptr<KWaylandServer::TearingControlManagerV1Interface> m_tearingControlInterface;
    std::unique_ptr<KWaylandServer::XwaylandShellV1Interface> m_xwaylandShell;
    std::unique_ptr<KWaylandServer::ViewporterInterface> m_viewporter;
    std::unique_ptr<KWaylandServer::FractionalScaleManagerV1Interface> m_fractionalScaleManager;
    ...
    std::unique_ptr<KWaylandServer::IdleInhibitManagerV1Interface> m_idleInhibitManager;
    std::unique_ptr<KWaylandServer::IdleNotifyV1Interface> m_idleNotifyInterface;
    ...
    std::unique_ptr<KWaylandServer::XdgActivationV1Interface> m_xdgActivation;
    ...
    std::unique_ptr<LayerShellV1Integration> m_layerShellIntegration;
