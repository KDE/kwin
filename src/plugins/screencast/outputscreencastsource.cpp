...
void OutputScreenCastSource::resume()
{
    ...
    // needs to be a queued connection, as rendering may schedule repaints!
    connect(m_layer.get(), &OutputLayer::repaintScheduled, this, &OutputScreenCastSource::report, Qt::QueuedConnection);
