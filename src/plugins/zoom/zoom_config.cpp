    ...
    : KCModule(parent, data)
{
    ...
    if (KWindowSystem::isPlatformWayland()) {
        ...
        m_ui.formLayout->addRow(new QLabel(i18n("Wheel gesture modifier keys:")), axisGesture);
        m_ui.formLayout->addRow(nullptr, new QLabel(i18n("Use the mouse wheel while the modifier keys are pressed to zoom")));
    }
