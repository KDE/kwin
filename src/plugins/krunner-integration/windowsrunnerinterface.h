...
private:
    ...
    RemoteMatch windowsMatch(const Window *window, const WindowsRunnerAction action = ActivateAction, qreal relevance = 1.0, KRunner::QueryMatch::CategoryRelevance type = KRunner::QueryMatch::CategoryRelevance::Highest) const;
