    ...
    , m_exposeClassCurrentDesktopAction(new QAction(this))
{
    ...
    loadFromModule(QStringLiteral("org.kde.kwin.windowview"), QStringLiteral("Main"));

    m_exposeAction->setObjectName(QStringLiteral("Expose"));
    m_exposeAction->setText(i18n("Toggle Present Windows (Current desktop)"));
    KGlobalAccel::self()->setDefaultShortcut(m_exposeAction, QList<QKeySequence>() << (Qt::META | Qt::Key_F9) << (Qt::CTRL | Qt::Key_F9));
    KGlobalAccel::self()->setShortcut(m_exposeAction, QList<QKeySequence>() << (Qt::META | Qt::Key_F9) << (Qt::CTRL | Qt::Key_F9));
    ...
    KGlobalAccel::self()->setDefaultShortcut(m_exposeAllAction, QList<QKeySequence>() << (Qt::META | Qt::Key_F10) << Qt::Key_LaunchC << (Qt::CTRL | Qt::Key_F10));
    KGlobalAccel::self()->setShortcut(m_exposeAllAction, QList<QKeySequence>() << (Qt::META | Qt::Key_F10) << Qt::Key_LaunchC << (Qt::CTRL | Qt::Key_F10));
    ...
    KGlobalAccel::self()->setDefaultShortcut(m_exposeClassAction, QList<QKeySequence>() << (Qt::META | Qt::Key_F7) << (Qt::CTRL | Qt::Key_F7));
    KGlobalAccel::self()->setShortcut(m_exposeClassAction, QList<QKeySequence>() << (Qt::META | Qt::Key_F7) << (Qt::CTRL | Qt::Key_F7));
...
void WindowViewEffect::reconfigure(ReconfigureFlags)
{
    ...
    auto touchCallback = [this](ElectricBorder border, const QPointF &deltaProgress, const LogicalOutput *screen) {
