...
void OutputLocatorEffect::show()
{
    ...
    for (const auto screen : screens) {
        ...
        scene->setSource(QUrl(QStringLiteral("qrc:/org.kde.kwin/outputlocator/qml/OutputLabel.qml")), {{QStringLiteral("outputName"), outputName(screen)}, {QStringLiteral("resolution"), screen->pixelSize()}, {QStringLiteral("scale"), screen->scale()}});
