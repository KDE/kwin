...
private:
    ...
    void doContrast(const RenderTarget &renderTarget, EffectWindow *w, const QRegion &shape, const QRect &screen, const float opacity, const QMatrix4x4 &screenProjection);
