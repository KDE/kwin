...
void OverviewEffect::reconfigure(ReconfigureFlags)
{
    ...
    setAnimationDuration(animationTime(500));
...
void OverviewEffect::activate()
{
    ...
    // This is an ugly hack to make hidpi rendering on wayland work as expected. For more
    // details, see https://codereview.qt-project.org/c/qt/qtdeclarative/+/361506
    if (effects->waylandDisplay()) {
