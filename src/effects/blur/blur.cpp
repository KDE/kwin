...
void BlurEffect::drawWindow(const RenderTarget &renderTarget, const ViewPort &viewPort, EffectWindow *w, int mask, const QRegion &region, WindowPaintData &data)
{
...
void BlurEffect::doBlur(const RenderTarget &renderTarget, const ViewPort &viewPort, const QRegion &shape, const QRect &screen, const float opacity, const QMatrix4x4 &screenProjection, bool isDock, QRect windowRect)
{
...
void BlurEffect::upscaleRenderToScreen(const ViewPort &viewPort, GLVertexBuffer *vbo, int vboStart, int blurRectCount, const QMatrix4x4 &screenProjection, QPoint windowPosition)
{
