...
void TouchPointsEffect::paintScreen(const RenderTarget &renderTarget, const ViewPort &viewPort, int mask, const QRegion &region, ScreenPaintData &data)
{
...
void TouchPointsEffect::drawCircle(const ViewPort &viewPort, const QColor &color, float cx, float cy, float r)
{
...
void TouchPointsEffect::drawCircleGl(const ViewPort &viewPort, const QColor &color, float cx, float cy, float r)
{
