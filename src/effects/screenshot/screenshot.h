...
private:
    ...
    bool takeScreenShot(const ViewPort &viewPort, ScreenShotAreaData *screenshot);
    bool takeScreenShot(const ViewPort &viewPort, ScreenShotScreenData *screenshot);
    ...
    QImage blitScreenshot(const ViewPort &viewPort, const QRect &geometry, qreal devicePixelRatio = 1.0) const;
