...
private:
    ...
    inline void drawCircle(const ViewPort &viewPort, const QColor &color, float cx, float cy, float r);
    ...
    void drawCircleGl(const ViewPort &viewPort, const QColor &color, float cx, float cy, float r);
