...
void MouseClickEffect::paintScreen(const RenderTarget &renderTarget, const ViewPort &viewPort, int mask, const QRegion &region, ScreenPaintData &data)
{
...
void MouseClickEffect::drawCircle(const ViewPort &viewPort, const QColor &color, float cx, float cy, float r)
{
...
void MouseClickEffect::drawCircleGl(const ViewPort &viewPort, const QColor &color, float cx, float cy, float r)
{
