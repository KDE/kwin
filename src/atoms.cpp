...
Atoms::Atoms()
    ...
    , multiple(QByteArrayLiteral("MULTIPLE"))
    , save_targets(QByteArrayLiteral("SAVE_TARGETS"))
    ...
    , xwayland_xrandr_emulation(QByteArrayLiteral("_XWAYLAND_RANDR_EMU_MONITOR_RECTS"))
