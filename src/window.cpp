...
void Window::maybeSendFrameCallback()
{
    if (m_surface && !m_windowItem->isVisible()) {
        ...
        m_surface->presented(nullptr, std::chrono::nanoseconds(1'000'000'000'000 / output()->refreshRate()), std::chrono::steady_clock::now().time_since_epoch(), PresentationMode::VSync);
