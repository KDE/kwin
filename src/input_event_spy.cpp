...
void InputEventSpy::strokeGestureBegin(const std::vector<QPointF> &points, std::chrono::microseconds time)
{
}

void InputEventSpy::strokeGestureUpdate(const std::vector<QPointF> &points, std::chrono::microseconds time)
{
}
