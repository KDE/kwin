...
/*!
    ...
    \brief The KRect class defines a rectangle in the plane using
    integer precision.

    A rectangle is normally expressed as a top-left corner and a
    size.  The size (width and height) of a KRect is always equivalent
    to the mathematical rectangle that forms the basis for its
    rendering.

    A KRect can be constructed with a set of left, top, width and
    ...
    There is a third constructor that creates a KRect using the
    ...
    The KRect class provides a collection of functions that return the
    various rectangle coordinates, and enable manipulation of
    these. KRect also provides functions to move the rectangle relative
    ...
    this rectangle intersects with a given rectangle. The KRect class
    ...
    Note that due to the way KRect and KRectF are defined, an
    empty KRect is defined in essentially the same way as KRectF.

    Finally, KRect objects can be streamed as well as compared.
    ...
    the boundary line of a KRect will be rendered symmetrically on
    both sides of the mathematical rectangle's boundary line. But when
    using an aliased painter (the default) other rules apply.

    Then, when rendering with a one pixel wide pen the KRect's boundary
    ...
    bottom(). Another solution is to use KRectF: The KRectF class
    defines a rectangle in the plane using floating point accuracy for
    coordinates, and the KRectF::right() and KRectF::bottom()
    ...
    In addition, KRect provides the getCoords() function which extracts
    ...
    KRect is limited to the minimum and maximum values for the \c int type.
    Operations on a KRect that could potentially result in values outside this
...
/*!
    \fn KRect::KRect(const QPoint &topLeft, const QPoint &bottomRight)
...
/*!
    \fn KRect::KRect(const QPoint &topLeft, const QSize &size)
...
/*!
    \fn KRect::KRect(int x, int y, int width, int height)
...
KRect KRect::normalized() const noexcept
{
    KRect r;
...
/*!
    \fn void KRect::setTopLeft(const QPoint &position)
...
/*!
    \fn void KRect::setBottomRight(const QPoint &position)
...
/*!
    \fn void KRect::setTopRight(const QPoint &position)
...
/*!
    \fn void KRect::setBottomLeft(const QPoint &position)
...
/*!
    \fn QPoint KRect::bottomRight() const
...
/*!
    \fn QPoint KRect::topRight() const
...
/*!
    \fn QPoint KRect::bottomLeft() const
...
/*!
    \fn void KRect::getRect(int *x, int *y, int *width, int *height) const
...
/*!
    \fn void KRect::getCoords(int *x1, int *y1, int *x2, int *y2) const
...
/*!
    \fn void KRect::moveBottom(int y)
...
/*!
    \fn void KRect::moveTopLeft(const QPoint &position)
...
/*!
    \fn void KRect::moveBottomRight(const QPoint &position)
...
/*!
    \fn void KRect::moveTopRight(const QPoint &position)
...
/*!
    \fn void KRect::moveBottomLeft(const QPoint &position)
...
/*!
    \fn void KRect::moveCenter(const QPoint &position)
...
/*!
    \fn void KRect::moveTo(int x, int y)
...
/*!
    \fn void KRect::moveTo(const QPoint &position)
...
/*!
    \fn void KRect::translate(int dx, int dy)
...
/*!
    \fn void KRect::translate(const QPoint &offset)
    \overload
...
/*!
    \fn KRect KRect::translated(int dx, int dy) const
...
/*!
    \fn KRect KRect::translated(const QPoint &offset) const
...
/*!
    \fn KRect KRect::transposed() const
    \since 5.7
...
/*!
    \fn void KRect::setRect(int x, int y, int width, int height)
...
/*!
    \fn void KRect::setCoords(int x1, int y1, int x2, int y2)
...
/*! \fn KRect KRect::adjusted(int dx1, int dy1, int dx2, int dy2) const
...
/*! \fn void KRect::adjust(int dx1, int dy1, int dx2, int dy2)
...
/*!
    \fn void KRect::setWidth(int width)
...
/*!
    \fn void KRect::setHeight(int height)
...
/*!
    \fn void KRect::setSize(const QSize &size)
...
/*!
    \fn bool KRect::contains(const QPoint &point, bool proper) const
...
bool KRect::contains(const QPoint &p, bool proper) const noexcept
{
    int l, r;
    if (x2 < x1 - 1) {
        l = x2;
...
/*!
    \fn bool KRect::contains(int x, int y, bool proper) const
    \overload
...
/*!
    \fn bool KRect::contains(int x, int y) const
    \overload
...
/*!
    \fn bool KRect::contains(const KRect &rectangle, bool proper) const
    \overload
...
bool KRect::contains(const KRect &r, bool proper) const noexcept
{
    if (isNull() || r.isNull())
        return false;
...
/*!
    \fn KRect& KRect::operator|=(const KRect &rectangle)
...
/*!
    \fn KRect KRect::operator|(const KRect &rectangle) const
...
KRect KRect::operator|(const KRect &r) const noexcept
{
    if (isNull())
        return r;
    if (r.isNull())
...
/*!
    \fn KRect KRect::unite(const KRect &rectangle) const
    \obsolete
...
/*!
    \fn KRect KRect::united(const KRect &rectangle) const
    \since 4.2
...
/*!
    \fn KRect KRect::intersect(const KRect &rectangle) const
    \obsolete
...
/*!
    \fn KRect KRect::intersected(const KRect &rectangle) const
    \since 4.2
...
/*!
    \fn bool KRect::intersects(const KRect &rectangle) const
...
bool KRect::intersects(const KRect &r) const noexcept
{
    if (isNull() || r.isNull())
        return false;
...
/*!
    \fn bool operator==(const KRect &r1, const KRect &r2)
    \relates KRect
...
/*!
    \fn KRect operator+(const KRect &rectangle, const QMargins &margins)
    \relates KRect
...
/*!
    \fn KRect operator+(const QMargins &margins, const KRect &rectangle)
    \relates KRect
    \overload
...
/*!
    \fn KRect operator-(const KRect &lhs, const QMargins &rhs)
    \relates KRect
...
/*!
    \fn KRect KRect::marginsAdded(const QMargins &margins) const
...
/*!
    \fn KRect KRect::operator+=(const QMargins &margins)
...
/*!
    \fn KRect KRect::marginsRemoved(const QMargins &margins) const
...
/*!
    \fn QDataStream &operator<<(QDataStream &stream, const KRect &rectangle)
    \relates KRect
...
QDataStream &operator<<(QDataStream &s, const KRect &r)
{
    if (s.version() == 1)
...
/*!
    \fn QDataStream &operator>>(QDataStream &stream, KRect &rectangle)
    \relates KRect
...
QDataStream &operator>>(QDataStream &s, KRect &r)
{
    if (s.version() == 1) {
        qint16 x1, y1, x2, y2;
        s >> x1; s >> y1; s >> x2; s >> y2;
...
QDebug operator<<(QDebug dbg, const KRect &r)
{
    QDebugStateSaver saver(dbg);
    dbg.nospace();
    dbg << "KRect" << '(';
    dbg << r.x() << ',' << r.y() << ' ' << r.width() << 'x' << r.height();
    dbg << ')';
    return dbg;
}
#endif
...
/*!
    ...
    \brief The KRectF class defines a rectangle in the plane using floating
    point precision.

    A rectangle is normally expressed as a top-left corner and a
    size.  The size (width and height) of a KRectF is always equivalent
    to the mathematical rectangle that forms the basis for its
    rendering.

    A KRectF can be constructed with a set of left, top, width and
    ...
    There is also a third constructor creating a KRectF from a KRect,
    and a corresponding toRect() function that returns a KRect object
    ...
    The KRectF class provides a collection of functions that return
    the various rectangle coordinates, and enable manipulation of
    these. KRectF also provides functions to move the rectangle
    ...
    false). The KRectF class also provides the intersected() function
    ...
    Note that due to the way KRect and KRectF are defined, an
    empty KRectF is defined in essentially the same way as KRect.

    Finally, KRectF objects can be streamed as well as compared.
    ...
    When using an \l {QPainter::Antialiasing}{anti-aliased} painter,
    the boundary line of a KRectF will be rendered symmetrically on both
    sides of the mathematical rectangle's boundary line. But when
    using an aliased painter (the default) other rules apply.

    Then, when rendering with a one pixel wide pen the KRectF's boundary
    line will be rendered to the right and below the mathematical
    rectangle's boundary line.
    ...
    In addition, KRectF provides the getCoords() function which extracts
    the position of the rectangle's top-left and bottom-right corner,
    and the getRect() function which extracts the rectangle's top-left
    corner, width and height. Use the setCoords() and setRect()
    function to manipulate the rectangle's coordinates and dimensions
...
/*!
    \fn KRectF::KRectF(const QPointF &topLeft, const QSizeF &size)
...
/*!
    \fn KRectF::KRectF(const QPointF &topLeft, const QPointF &bottomRight)
    \since 4.3
...
/*!
    \fn KRectF::KRectF(qreal x, qreal y, qreal width, qreal height)
...
/*!
    \fn KRectF::KRectF(const KRect &rectangle)

    Constructs a KRectF rectangle from the given KRect \a rectangle.

    \sa toRect()
*/

/*!
    \fn bool KRectF::isNull() const
...
KRectF KRectF::normalized() const noexcept
{
    KRectF r = *this;
    if (r.w < 0) {
        r.xp += r.w;
...
/*!
    \fn void KRectF::setLeft(qreal x)
...
/*!
    \fn void KRectF::setRight(qreal x)
...
/*!
    \fn void KRectF::setBottom(qreal y)
...
/*!
    \fn void KRectF::setTopLeft(const QPointF &position)
...
/*!
    \fn void KRectF::setBottomRight(const QPointF &position)
...
/*!
    \fn void KRectF::setTopRight(const QPointF &position)
...
/*!
    \fn void KRectF::setBottomLeft(const QPointF &position)
...
/*!
    \fn QPointF KRectF::center() const
...
/*!
    \fn void KRectF::getRect(qreal *x, qreal *y, qreal *width, qreal *height) const
...
/*!
    \fn void KRectF::getCoords(qreal *x1, qreal *y1, qreal *x2, qreal *y2) const
...
/*!
    \fn void KRectF::moveLeft(qreal x)
...
/*!
    \fn void KRectF::moveTop(qreal y)
...
/*!
    \fn void KRectF::moveRight(qreal x)
...
/*!
    \fn void KRectF::moveBottom(qreal y)
...
/*!
    \fn void KRectF::moveTopLeft(const QPointF &position)
...
/*!
    \fn void KRectF::moveBottomRight(const QPointF &position)
...
/*!
    \fn void KRectF::moveTopRight(const QPointF &position)
...
/*!
    \fn void KRectF::moveBottomLeft(const QPointF &position)
...
/*!
    \fn void KRectF::moveTo(qreal x, qreal y)
...
/*!
    \fn void KRectF::moveTo(const QPointF &position)
    \overload
...
/*!
    \fn void KRectF::translate(qreal dx, qreal dy)
...
/*!
    \fn void KRectF::translate(const QPointF &offset)
    \overload
...
/*!
    \fn KRectF KRectF::translated(qreal dx, qreal dy) const
...
/*!
    \fn KRectF KRectF::translated(const QPointF &offset) const
    \overload
...
/*!
    \fn KRectF KRectF::transposed() const
    \since 5.7
...
/*!
    \fn void KRectF::setRect(qreal x, qreal y, qreal width, qreal height)
...
/*!
    \fn void KRectF::setCoords(qreal x1, qreal y1, qreal x2, qreal y2)
...
/*!
    \fn KRectF KRectF::adjusted(qreal dx1, qreal dy1, qreal dx2, qreal dy2) const
...
/*! \fn void KRectF::adjust(qreal dx1, qreal dy1, qreal dx2, qreal dy2)
...
/*!
    \fn void KRectF::setWidth(qreal width)
...
/*!
    \fn void KRectF::setHeight(qreal height)
...
/*!
    \fn void KRectF::setSize(const QSizeF &size)
...
/*!
    \fn bool KRectF::contains(const QPointF &point) const
...
bool KRectF::contains(const QPointF &p) const noexcept
{
    qreal l = xp;
    qreal r = xp;
    if (w < 0)
...
/*!
    \fn bool KRectF::contains(qreal x, qreal y) const
    \overload
...
/*!
    \fn bool KRectF::contains(const KRectF &rectangle) const
    \overload
...
bool KRectF::contains(const KRectF &r) const noexcept
{
    qreal l1 = xp;
    qreal r1 = xp;
    if (w < 0)
...
/*!
    \fn QPointF KRectF::topLeft() const
...
/*!
    \fn QPointF KRectF::bottomRight() const
...
/*!
    \fn QPointF KRectF::topRight() const
...
/*!
    \fn QPointF KRectF::bottomLeft() const
...
/*!
    \fn KRectF& KRectF::operator|=(const KRectF &rectangle)
...
/*!
    \fn KRectF KRectF::operator|(const KRectF &rectangle) const
...
KRectF KRectF::operator|(const KRectF &r) const noexcept
{
    if (isNull())
        return r;
    if (r.isNull())
    ...
    return KRectF(left, top, right - left, bottom - top);
}

/*!
    \fn KRectF KRectF::unite(const KRectF &rectangle) const
    \obsolete
...
/*!
    \fn KRectF KRectF::united(const KRectF &rectangle) const
    \since 4.2
...
/*!
    \fn KRectF KRectF::intersect(const KRectF &rectangle) const
    \obsolete
...
/*!
    \fn KRectF KRectF::intersected(const KRectF &rectangle) const
    \since 4.2
...
/*!
    \fn bool KRectF::intersects(const KRectF &rectangle) const
...
bool KRectF::intersects(const KRectF &r) const noexcept
{
    qreal l1 = xp;
    qreal r1 = xp;
    if (w < 0)
...
/*!
    \fn KRect KRectF::toRect() const

    Returns a KRect based on the values of this rectangle.  Note that the
    coordinates in the returned rectangle are rounded to the nearest integer.

    \sa KRectF(), toAlignedRect()
*/

/*!
    \fn KRect KRectF::toAlignedRect() const
    \since 4.3

    Returns a KRect based on the values of this rectangle that is the
...
KRect KRectF::toAlignedRect() const noexcept
{
    int xmin = int(qFloor(xp));
    int xmax = int(qCeil(xp + w));
    int ymin = int(qFloor(yp));
    int ymax = int(qCeil(yp + h));
    return KRect(xmin, ymin, xmax - xmin, ymax - ymin);
}

/*!
    \fn void KRectF::moveCenter(const QPointF &position)
...
/*!
    \fn bool operator==(const KRectF &r1, const KRectF &r2)
    \relates KRectF
...
/*!
    \fn KRectF operator+(const KRectF &lhs, const QMarginsF &rhs)
    \relates KRectF
    \since 5.3
...
/*!
    \fn KRectF operator+(const QMarginsF &lhs, const KRectF &rhs)
    \relates KRectF
    \overload
    \since 5.3
...
/*!
    \fn KRectF KRectF::marginsAdded(const QMarginsF &margins) const
    \since 5.3
...
/*!
    \fn KRectF KRectF::marginsRemoved(const QMarginsF &margins) const
    \since 5.3
...
/*!
    \fn KRectF KRectF::operator+=(const QMarginsF &margins)
    \since 5.3
...
#ifndef QT_NO_DATASTREAM
/*!
    \fn QDataStream &operator<<(QDataStream &stream, const KRectF &rectangle)
...
QDataStream &operator<<(QDataStream &s, const KRectF &r)
{
...
/*!
    \fn QDataStream &operator>>(QDataStream &stream, KRectF &rectangle)
...
QDataStream &operator>>(QDataStream &s, KRectF &r)
{
    double x, y, w, h;
    s >> x;
    s >> y;
...
#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug dbg, const KRectF &r)
{
    QDebugStateSaver saver(dbg);
    dbg.nospace();
    dbg << "KRectF" << '(';
