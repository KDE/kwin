...
class KWIN_EXPORT StrutRect : public RectF
{
public:
    explicit StrutRect(RectF rect = RectF(), StrutArea area = StrutAreaInvalid);
    StrutRect(const QPointF &topLeft, const QPointF &bottomRight, StrutArea area = StrutAreaInvalid);
