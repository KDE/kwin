...
bool InputEventFilter::strokeGestureBegin(const std::vector<QPointF> &points, std::chrono::microseconds time)
{
    return false;
}

bool InputEventFilter::strokeGestureUpdate(const std::vector<QPointF> &points, std::chrono::microseconds time)
{
    return false;
}
...
void InputRedirection::registerStrokeShortcut(const std::vector<QPointF> &points, QAction *action)
{
#if KWIN_BUILD_GLOBALSHORTCUTS
