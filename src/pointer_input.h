...
public:
     ...
     * @internal
     */
    void processStrokeGestureBegin(const std::vector<QPointF> &points, std::chrono::microseconds time, KWin::InputDevice *device = nullptr);
    /**
     * @internal
     */
    void processStrokeGestureUpdate(const std::vector<QPointF> &points, std::chrono::microseconds time, KWin::InputDevice *device = nullptr);
    /**
     * @internal
     */
