...
namespace
{
const QMap<QString, KDecoration2::BorderSize> s_borderSizes{{QStringLiteral("None"), KDecoration2::BorderSize::None},
...
const QMap<KDecoration2::BorderSize, QString> s_borderSizeNames{{KDecoration2::BorderSize::None, i18n("No Borders")},
...
const QHash<KDecoration2::DecorationButtonType, QChar> s_buttonNames{{KDecoration2::DecorationButtonType::Menu, QChar('M')},
