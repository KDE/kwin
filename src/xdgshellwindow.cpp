...
{
    if (m_nextDecoration) {
        disconnect(m_nextDecoration.get(), &KDecoration3::Decoration::stateRequested, this, &XdgToplevelWindow::processDecorationState);
    }
...
void XdgToplevelWindow::configureDecoration()
{
    ...
    case DecorationMode::Server:
        if (!m_nextDecoration) {
            ...
            if (m_nextDecoration) {
                connect(m_nextDecoration.get(), &KDecoration3::Decoration::stateRequested, this, &XdgToplevelWindow::processDecorationState);
