...
void XdgToplevelWindow::maximize(MaximizeMode mode)
{
    ...
    const QRectF clientArea = isElectricBorderMaximizing() ? workspace()->clientArea(MaximizeArea, this, Cursor::self()->pos()) : workspace()->clientArea(MaximizeArea, this, moveResizeOutput());
