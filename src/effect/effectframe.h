...
public:
     ...
     * Render the frame.
     */
    void render(const RenderTarget &renderTarget, const RenderViewport &viewport, const QRegion &logicalRegion = infiniteRegion(), double opacity = 1.0, double frameOpacity = 1.0);
