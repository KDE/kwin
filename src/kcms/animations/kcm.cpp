    ...
    : KQuickConfigModule(parent, metaData)
{
    ...
    // TODO: Whilst we only have the one setting in AnimationsGlobalsSettings, surely there's a signal for *any* setting change, not just having to connect to each one?
