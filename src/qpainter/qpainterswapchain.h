...
{
public:
    QPainterSwapchainSlot(std::shared_ptr<GraphicsBuffer> &&buffer, std::unique_ptr<GraphicsBufferView> &&view);
    ...
    static std::shared_ptr<QPainterSwapchainSlot> create(std::shared_ptr<GraphicsBuffer> &&buffer);
