...
public:
    ...
    bool scheduleFrame(std::optional<std::chrono::steady_clock::time_point> targetTime = std::nullopt);
    bool scheduleFrameRecursive(std::optional<std::chrono::steady_clock::time_point> targetTime = std::nullopt);
