...
private:
    void renderPart(const QRectF &rect, const QRectF &partRect, const QPointF &textureOffset, qreal devicePixelRatio, bool rotated = false);
    static const QMarginsF texturePadForPart(const QRectF &rect, const QRectF &partRect);
    void resizeTexture();
