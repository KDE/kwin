...
public:
    ...
    void sendKey(quint32 key, KeyboardKeyState state, std::chrono::milliseconds timestamp);
    void sendKey(quint32 key, KeyboardKeyState state, ClientConnection *client, std::chrono::milliseconds timestamp);
