...
OutputDeviceV2Interface::OutputDeviceV2Interface(Display *display, KWin::Output *handle)
...
{
    std::vector<std::unique_ptr<OutputDeviceModeV2Interface>> oldModes = std::move(d->m_modes);
    d->m_modes.clear();
