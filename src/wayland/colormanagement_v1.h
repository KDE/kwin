...
#include "wayland/qwayland-server-wp-color-management-v4.h"
#include <QObject>
#include <QPointer>
...
private:
    ...
    void wp_color_manager_v1_get_feedback_surface(Resource *resource, uint32_t id, struct ::wl_resource *surface) override;
    void wp_color_manager_v1_new_icc_creator(Resource *resource, uint32_t obj) override;
    void wp_color_manager_v1_new_parametric_creator(Resource *resource, uint32_t obj) override;
};

class ColorFeedbackSurfaceV1 : private QtWaylandServer::wp_color_management_feedback_surface_v1
{
public:
...
private:
    void wp_color_management_feedback_surface_v1_destroy_resource(Resource *resource) override;
    void wp_color_management_feedback_surface_v1_destroy(Resource *resource) override;
    void wp_color_management_feedback_surface_v1_get_preferred(Resource *resource, uint32_t image_description) override;
...
{
public:
    explicit ImageDescriptionV1(wl_client *client, uint32_t id, uint32_t version, const ColorDescription &color);
