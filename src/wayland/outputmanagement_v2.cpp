...
{
    if (resource->version() < KDE_MODE_LIST_V2_ADD_CVT_SINCE_VERSION) {
        failureReason = i18n("Setting custom modes with too old kde-output-management-v2 protocol versions is unsupported");
        return;
    }
