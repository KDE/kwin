...
{
public:
    std::optional<QtWaylandServer::xdg_dbus_annotation_v1::bus_enum> bus;
    std::optional<QString> busName;
...
private:
    ...
    void xdg_dbus_annotation_v1_set_bus(Resource *resource, uint32_t bus) override;
    void xdg_dbus_annotation_v1_set_bus_name(Resource *resource, const QString &service_name) override;
    void xdg_dbus_annotation_v1_set_object_path(Resource *resource, const QString &object_path) override;

    QPointer<SurfaceInterface> m_surface;
    QString m_interface;
    std::optional<bus_enum> m_bus;
    QString m_busName;
