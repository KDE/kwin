    ...
    , d(new OutputDeviceV2InterfacePrivate(this, display, handle))
{
    ...
    connect(handle, &Output::hdrBrightnessChanged, this, &OutputDeviceV2Interface::updateBrightness);
}
...
{
    const uint32_t newBrightness = std::round(d->m_handle->hdrBrightness() * 10'000);
