...
public:
    ...
    color_power_tradeoff m_powerColorTradeoff = color_power_tradeoff_balanced;
    QTimer m_doneTimer;
...
void OutputDeviceV2Interface::updateColorPowerTradeoff()
{
    const auto colorPowerTradeoff = [this]() {
        ...
        case Output::ColorPowerTradeoff::PreferLowPower:
            return QtWaylandServer::kde_output_device_v2::color_power_tradeoff_lowpower;
        case Output::ColorPowerTradeoff::Balanced:
            return QtWaylandServer::kde_output_device_v2::color_power_tradeoff_balanced;
