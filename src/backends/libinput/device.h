...
class KWIN_EXPORT Device : public InputDevice
{
    ...
    Q_PROPERTY(QList<quint32> numModes READ numModes CONSTANT)
    Q_PROPERTY(QList<quint32> currentModes READ currentModes NOTIFY currentModesChanged)
...
public:
    ...
    QList<quint32> numModes() const;
    QList<quint32> currentModes() const;
