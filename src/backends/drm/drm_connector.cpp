...
DrmConnector::DrmConnector(DrmGpu *gpu, uint32_t connectorId)
    : DrmObject(gpu,
                connectorId,
                {
                    ...
                    PropertyDefinition("non-desktop", Requirement::Optional),
                    PropertyDefinition("DPMS", Requirement::RequiredForLegacy),
                    PropertyDefinition("EDID", Requirement::Optional),
                    PropertyDefinition("overscan", Requirement::Optional),
                    PropertyDefinition("vrr_capable", Requirement::Optional),
                    PropertyDefinition("underscan", Requirement::Optional, {"off", "on", "auto"}),
                    PropertyDefinition("underscan vborder", Requirement::Optional),
                    PropertyDefinition("underscan hborder", Requirement::Optional),
                    PropertyDefinition("Broadcast RGB", Requirement::Optional, {"Automatic", "Full", "Limited 16:235"}),
                    PropertyDefinition("max bpc", Requirement::Optional),
                    PropertyDefinition("link-status", Requirement::Optional, {"Good", "Bad"}),
                    PropertyDefinition("content type", Requirement::Optional, {"No Data", "Graphics", "Photo", "Cinema", "Game"}),
                    PropertyDefinition("panel orientation", Requirement::Optional, {"Normal", "Upside Down", "Left Side Up", "Right Side Up"}),
                    PropertyDefinition("HDR_OUTPUT_METADATA", Requirement::Optional),
                    PropertyDefinition("scaling mode", Requirement::Optional, {"None", "Full", "Center", "Full aspect"}),
                },
