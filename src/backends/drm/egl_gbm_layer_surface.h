...
public:
    ...
    std::optional<QRegion> startRendering(const QSize &bufferSize, const QRect &geometry, DrmPlane::Transformations renderTransform,
                                          DrmPlane::Transformations bufferTransform, const QMap<uint32_t, QVector<uint64_t>> &formats);
