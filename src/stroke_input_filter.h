...
private:
    ...
    /**
     * The activation button if no device-specific button is given in m_activationButton.
     * This should be either NoButton or RightButton, because we can only really rely
     * on the RMB to be similar for all devices, whereas extra buttons could be located anywhere.
     * MiddleButton could perhaps be considered viable, it's available on *most* devices.
     */
    Qt::MouseButton m_defaultActivationButton = Qt::MouseButton::NoButton;
