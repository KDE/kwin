...
public:
    ...
    void paintWindow(const RenderTarget &renderTarget, const ViewPort &viewPort, EffectWindow *w, int mask, const QRegion &region, WindowPaintData &data) override;
    ...
    void renderWindow(const RenderTarget &renderTarget, const ViewPort &viewPort, EffectWindow *w, int mask, const QRegion &region, WindowPaintData &data) override;
    ...
    void renderOffscreenQuickView(const RenderTarget &renderTarget, const ViewPort &viewPort, OffscreenQuickView *effectQuickView) const override;
...
public:
    ...
    void free() override;
    void render(const RenderTarget &renderTarget, const ViewPort &viewPort, const QRegion &region = infiniteRegion(), double opacity = 1.0, double frameOpacity = 1.0) override;
