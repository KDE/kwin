...
public:
    ...
    void registerStrokeShortcut(const std::vector<QPointF> &points, QAction *action);
...
public:
    ...
    virtual bool strokeGestureBegin(const std::vector<QPointF> &points, std::chrono::microseconds time);
    virtual bool strokeGestureUpdate(const std::vector<QPointF> &points, std::chrono::microseconds time);
